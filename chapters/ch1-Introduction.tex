...
% TODO
% Scorch, is it the optimiser or the deoptimiser ?
% Because Slang experience, we chose not to go in restricted Smalltalk direction for metacircular
% Main Phd task was to build for Pharo an optimising JIT, on top of the existing runtime, not replacing
