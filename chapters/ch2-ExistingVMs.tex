...
\paragraph{Aside from loops.} Some meta-tracing JITs are able to trace code aside from loops. In this case, profiling counters are added on functions to see if they are worth compiling or not.
