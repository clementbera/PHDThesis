...
%names := ' A* & 65.63 +- 1.04 & 71.83 +- 1.13 & 59.8 +- 15.30 & 45 +- 0.35 \\
%    Binary tree & 9.31 +- 0.09 & 8.72 +- 0.08 & 6.3 +- 0.26 & 5.96 +- 0.04 \\
%    Delta Blue & 5.64 +- 0.01 & 6.5 +- 0.02 & 4.96 +- 0.03 & 4.99 +- 0.01 \\
%    JSON parsing & 255.23 +- 0.34 & 257.2 +- 0.46 & 336.3 +- 35.90 & 256.89 +- 0.38 \\
%    Mandelbrot & 10.39 +- 0.02 & 10.41 +- 0.02 & 9.19 +- 0.05 & 7.93 +- 0.03 \\
%    Richards & 57.43 +- 0.17 & 49.44 +- 1.07 & 184.6 +- 50.20 & 52.4 +- 6.36 \\
%    K-Nucleotide & 57.43 +- 0.17 & 49.44 +- 1.07 & 184.6 +- 50.20 & 52.4 +- 6.36 \\
%    Spectral Norm & 5.64 +- 0.01 & 6.5 +- 0.02 & 4.96 +- 0.03 & 4.99 +- 0.01 \\
%    Thread Ring & 5.64 +- 0.01 & 6.5 +- 0.02 & 4.96 +- 0.03 & 4.99 +- 0.01 \\
%    NBody & 5.64 +- 0.01 & 6.5 +- 0.02 & 4.96 +- 0.03 & 4.99 +- 0.01 \\
%    Meteor & 5.64 +- 0.01 & 6.5 +- 0.02 & 4.96 +- 0.03 & 4.99 +- 0.01 \\' splitOn: String cr.
%names := names collect: [ :each | (each splitOn: '&') first trim ].
%
%data := 'Cog      	68.39	0.485	9.301   	0.0811	44.33   	1.08	10.545	0.0174	1035.17  	4.99 	5.7419  	0.0119	3563.1  	28.6	305.983 	0.494	1237.70 	5.73	358.42	2.74  	282.858	0.658	1       	 1
%{Cog+Counters}	72.833	0.129	9.694     	0.0865	47.892  	0.638	10.826 	0.0089	1429.93 	1.2	6.388   	0.0045	3634.4  	21.8	332.983 	0.485	1244.93   	3.89	439.25	0.484	301.60	0.132	2       	 1
%{Sista (Cold)}	36.13	1.12	4.505   	0.13	36.86   	6.42	1.725	0.140	1876.4  	53.4	4.375   	0.115	3298.6  	71.8	347.15  	3.54	756     	106	329.5	22.9	229.5	24.8	3       	 1
%{Sista (Warm)}	35.252	0.0479	4.278     	0.0031	31.315   	0.601	2.181  	0.00826	1038.867  	0.604	4.3217  	0.0174 	3326.8     	20.0 	276.517     	0.347	686.27    	1.56 	281.883	0.836	202.07	1.480	4       	 1' splitOn: String cr.
%data := data collect: [ :each | (each splitOn: String tab) collect: #trim ].
%
%s := '' writeStream.
...
%	1 to: 4 do: [ :j |
%		s << ' & '.
%		s << ((data at: j) at: index + 1) asString.
%		s << ' +- '.
%		s << ((data at: j) at: index + 2) asString ].
%	s << ' \\'.
%	s cr
%	 ].
%s contents
